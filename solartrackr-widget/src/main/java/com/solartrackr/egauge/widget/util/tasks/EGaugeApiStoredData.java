...
/**
 * Created by ludlumm on 1/28/2016.
 */
public class EGaugeApiStoredData  extends AsyncTask<URL, Void, EGaugeStoredDataResponse> {



        public static String LOG_TAG = "API_Async";
        @Override
        protected EGaugeStoredDataResponse doInBackground(URL[] params) {
